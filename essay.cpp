...
void Essay::table()
{
    ...
    model->setHeaderData(1, Qt::Horizontal, tr("稿件类型"));
    model->setHeaderData(2, Qt::Horizontal, tr("作者编号"));
    model->setHeaderData(3, Qt::Horizontal, tr("投稿日期"));
    model->setHeaderData(4, Qt::Horizontal, tr("审核状态"));
    tableView->setModel(model);
    tableView->setGeometry(320, 80, 503, 470);
    tableView->show();
      ...
      /*  QSqlQuery sql_query;
       // sql_query.prepare("drop table essay");
        ...
        QString create_sql = "create table essay ( 稿件编号 varchar(12) primary key, "
                             "稿件类型 varchar(15), 作者编号 varchar(12) constraint "
                             "fk_author references author(作者编号), "
                             "投稿日期 date, 审核状态 varchar(20))";
...
void Essay::info1()
{
    ...
    lab5->setGeometry(50, 220, 100, 30);
    ...
    line5->setGeometry(120, 220, 200, 30);

    confirm->setGeometry(60, 280, 80, 30);
    cancel->setGeometry(260, 280, 80, 30);
...
void Essay::info2()
{
    ...
    lab5->setGeometry(50, 230, 100, 30);
    ...
    line5->setGeometry(120, 230, 200, 30);

    confirm->setGeometry(60, 275, 80, 30);
    cancel->setGeometry(260, 275, 80, 30);
...
void Essay::info3()
{
    ...
    hint2->setGeometry(20, 250, 130, 20);
    hint2->show();
    ...
    lab8 = new QLabel(subWin);
    lab9 = new QLabel(subWin);
    ...
    line8 = new QLineEdit(subWin);
    line9 = new QLineEdit(subWin);
    ...
    lab8->setFont(QFont(QString::fromLocal8Bit("微软雅黑"), 10));
    lab9->setFont(QFont(QString::fromLocal8Bit("微软雅黑"), 10));
    ...
    lab5->setGeometry(50, 200, 100, 30);
    lab6->setGeometry(50, 280, 100, 30);
    lab7->setGeometry(50, 320, 100, 30);
    lab8->setGeometry(50, 360, 100, 30);
    lab9->setGeometry(50, 400, 100, 30);

    line1->setGeometry(120, 40, 200, 30);
    line2->setGeometry(120, 80, 200, 30);
    line3->setGeometry(120, 120, 200, 30);
    line4->setGeometry(120, 160, 200, 30);
    line5->setGeometry(120, 200, 200, 30);
    line6->setGeometry(120, 280, 200, 30);
    line7->setGeometry(120, 320, 200, 30);
    line8->setGeometry(120, 360, 200, 30);
    line9->setGeometry(120, 400, 200, 30);

    confirm->setGeometry(60, 450, 80, 30);
    cancel->setGeometry(260, 450, 80, 30);
...
void Essay::Confirm4()
{
    ...
    if(cnt != 0) {
        QString select_sql = "select * from essay where ";
        for(int i = 0; i < cnt; i++) {
            select_sql += sele[i];
        }
